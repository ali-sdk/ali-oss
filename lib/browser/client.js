...
const setRegion = require('../common/utils/setRegion');
const _getReqUrl = require('../common/client/getReqUrl');
...
proto.createRequest = function createRequest(params) {
  ...
  if (_isIP(this.options.endpoint.hostname)) {
  ...
  const url = _getReqUrl.bind(this)(params);
