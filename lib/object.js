 ...
 *        {String} options.callback.callbackUrl  the OSS sends a callback request to this URL
 *        {String} options.callback.callbackHost  The host header value for initiating callback requests
 *        {String} options.callback.callbackBody  The value of the request body when a callback is initiated
 *        {String} options.callback.callbackBodyType  The Content-Type of the callback requests initiatiated
 *        {Object} options.callbackVar  Custom parameters are a map of key-values, e.g:
 *                   var callbackVar = {
 *                     key1: 'value1',
 *                     key2: 'value2'
 *                   }
