...
import pkg from '../../lib/browser/version';
import signUtils from '../common/signUtils';
import _isIP from '../common/utils/isIP';
import _initOptions from '../common/client/initOptions';
import { xml2objPromise } from '../common/utils/xml2obj';
...
proto.createRequest = function createRequest(params) {
  ...
  if (!getHeader(headers, 'Content-Type')) {
    ...
    if (params.mime && params.mime.indexOf('/') > 0) {
      ...
      headers['Content-Type'] = mime.getType(params.mime || extname(params.object || '')) || 'application/octet-stream';
    }
  }
