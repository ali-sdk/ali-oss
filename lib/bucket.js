...
proto.getBucketACL = function* (name, region, options) {
  options = options || {};
  options.subres = 'acl';
  var params = this._bucketRequestParams('GET', name, options);
  params.successStatuses = [200];
...
proto._bucketRequestParams = function (method, bucket, options) {
  return {
    method: method,
    bucket: bucket,
