...
proto.getBucketLocation = function* getBucketLocation(name, options) {
...
proto.getBucketInfo = function* getBucketInfo(name, options) {
  name = name || this.getBucket();
...
proto.putBucket = function* putBucket(name, options) {
  options = options || {};
...
proto.deleteBucket = function* deleteBucket(name, options) {
...
proto.putBucketACL = function* putBucketACL(name, acl, options) {
...
proto.getBucketACL = function* getBucketACL(name, options) {
...
proto.putBucketLogging = function* putBucketLogging(name, prefix, options) {
...
proto.getBucketLogging = function* getBucketLogging(name, options) {
...
proto.deleteBucketLogging = function* deleteBucketLogging(name, options) {
...
proto.putBucketWebsite = function* putBucketWebsite(name, config, options) {
  // config: index, [error]
...
proto.putBucketCORS = function* (name, rules, options) {
  rules = rules || [];
...
proto.getBucketCORS = function* (name, options) {
...
proto.deleteBucketCORS = function* (name, options) {
...
proto.putBucketReferer = function* putBucketReferer(name, allowEmpty, referers, options) {
...
proto.getBucketReferer = function* getBucketReferer(name, options) {
...
proto.deleteBucketReferer = function* deleteBucketReferer(name, options) {
  return yield this.putBucketReferer(name, true, null, options);
};
