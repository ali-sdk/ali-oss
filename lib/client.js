...
Client.initOptions = function initOptions(options) {
  ...
  if (opts.endpoint) {
    ...
    const withRegionEndpoint = setRegion(opts.region, opts.internal, opts.secure);
    opts.endpoint = (withRegionEndpoint.startsWith('oss-')) ? withRegionEndpoint : 'oss-' + withRegionEndpoint;
  } else {
