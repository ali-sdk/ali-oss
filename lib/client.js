...
const { computeSignature, buildCanonicalString, authorization } = require('./common/utils/signUtils');
...
proto.authorization = function (method, resource, subres, headers) {
  ...
  return authorization(this.options.accessKeyId, this.options.accessKeySecret, stringToSign);
};
