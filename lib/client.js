...
proto.authorization = function authorization(method, resource, subres, headers, query) {
  var params = [
    method.toUpperCase(),
    headers['Content-Md5'] || '',
...
proto.createRequest = function createRequest(params) {
  ...
  headers.authorization = this.authorization(
    params.method, authResource, params.subres, headers, params.query);
