...
proto.createRequest = function createRequest(params) {
  ...
  var stringToSign = signUtils.buildCanonicalString(params.method, authResource, {
    headers: headers,
    parameters: params.subres
  });
  headers.authorization = signUtils.authorization(this.options.accessKeyId, this.options.accessKeySecret, stringToSign);
