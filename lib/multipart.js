 ...
 * @return {Object} result.res response
 * @return {String} result.bucket bucket name
 * @return {String} result.name object key
 * @return {String} result.uploadId upload id, use for uploadPart, completeMultipart
 */
 ...
 * @param {File|String} file  is File or FileName, the whole file
 ...
 * @param {String} name the object name
 * @param {String} uploadId the upload id
 * @param {Array} parts the uploaded parts, contains object
 * @param {Object} part in the parts
 * @param {Number} part.number partNo
 * @param {String} part.etag  part etag  uploadPartCopy result.res.header.etag
 * @param {Object} options
 */
