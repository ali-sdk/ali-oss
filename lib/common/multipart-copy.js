 ...
 *          sourceKey {String} the source object name
 *          sourceBucketName {String} the source bucket name
 *          startOffset {Integer} data copy start byte offset, e.g: 0
 *          endOffset {Integer} data copy end byte offset, e.g: 102400
 * @param {Object} options
 *          {Integer} partSize
 */
proto.multipartUploadCopy = function* multipartUploadCopy(name, sourceData, options) {
  ...
  options = options || {};
  var objectMeta = yield this.getObjectMeta(sourceData.sourceBucketName, sourceData.sourceKey, {});
 ...
 * @param {Object} options
 */
proto.getObjectMeta = function* getObjectMeta(bucket, name, options) {
