 ...
 * @param {String} sourceData.sourceKey  the source object name
 * @param {String} sourceData.sourceBucketName  the source bucket name
 ...
 * @param {String} sourceData.sourceKey  the source object name
 * @param {String} sourceData.sourceBucketName  the source bucket name
 * @param {Number} sourceData.startOffset  data copy start byte offset, e.g: 0
 * @param {Number} sourceData.endOffset  data copy end byte offset, e.g: 102400
 * @param {Object} options
