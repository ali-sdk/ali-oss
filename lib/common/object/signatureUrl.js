...
const { checkBrowserEnv } = require('../utils/checkBrowserEnv');
const proto = exports;
...
proto.signatureUrl = function signatureUrl(name, options) {
  ...
  if (this.options.stsToken && isFunction(this.options.refreshSTSToken)) {
    checkBrowserEnv('If you want to refresh stsToken before signatureUrl, please replace asyncSignatureUrl');
  }
