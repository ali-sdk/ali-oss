...
const multipleObjectGet_1 = require('./multipleObjectGet');
const multipleUpload_1 = require('./multipleUpload');
const multipleDownload_1 = require('./multipleDownload');
const multipleDelete_1 = require('./multipleDelete');
...
exports.default = {
  ...
  // 兼容旧版本
  deleteObject: delete_1.deleteObject,
  ...
  // 兼容旧版本
  getObjectMeta: getObjectMeta_1.getObjectMeta,
  ...
  multipleObjectGet: multipleObjectGet_1.multipleObjectGet,
  multipleUpload: multipleUpload_1.multipleUpload,
  multipleDownload: multipleDownload_1.multipleDownload,
  multipleDelete: multipleDelete_1.multipleDelete
};
