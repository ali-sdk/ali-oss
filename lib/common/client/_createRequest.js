...
function _createRequest(params) {
    ...
    const authResource = getResource_1.getResource(params);
    headers.authorization = authorization_1.authorization(params.method, authResource, params.subres, headers, this.options);
