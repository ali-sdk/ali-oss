...
const checkBrowserAndVersion_1 = require("../utils/checkBrowserAndVersion");
...
async function multipartUploadCopy(name, sourceData, options = {}) {
    client_1.resetCancelFlag.call(this);
        ...
        return new Promise(async (resolve, reject) => {
            try {
                if (!client_1.isCancel.call(this)) {
                    ...
                    const result = await uploadPartCopy_1.uploadPartCopy.call(this, name, uploadId, partNo, range, source, uploadPartCopyOptions);
                    if (!client_1.isCancel.call(this)) {
