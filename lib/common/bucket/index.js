...
const abortBucketWorm_1 = require("./abortBucketWorm");
const completeBucketWorm_1 = require("./completeBucketWorm");
const deleteBucket_1 = require("./deleteBucket");
const deleteBucketCORS_1 = require("./deleteBucketCORS");
const deleteBucketEncryption_1 = require("./deleteBucketEncryption");
const deleteBucketInventory_1 = require("./deleteBucketInventory");
const deleteBucketLifecycle_1 = require("./deleteBucketLifecycle");
const deleteBucketLogging_1 = require("./deleteBucketLogging");
const deleteBucketPolicy_1 = require("./deleteBucketPolicy");
const deleteBucketReferer_1 = require("./deleteBucketReferer");
const deleteBucketTags_1 = require("./deleteBucketTags");
const deleteBucketWebsite_1 = require("./deleteBucketWebsite");
const extendBucketWorm_1 = require("./extendBucketWorm");
const getBucketACL_1 = require("./getBucketACL");
const getBucketCORS_1 = require("./getBucketCORS");
const getBucketEncryption_1 = require("./getBucketEncryption");
const getBucketInfo_1 = require("./getBucketInfo");
const getBucketInventory_1 = require("./getBucketInventory");
const getBucketLifecycle_1 = require("./getBucketLifecycle");
const getBucketLocation_1 = require("./getBucketLocation");
const getBucketLogging_1 = require("./getBucketLogging");
const getBucketPolicy_1 = require("./getBucketPolicy");
const getBucketReferer_1 = require("./getBucketReferer");
...
const getBucketWorm_1 = require("./getBucketWorm");
const initiateBucketWorm_1 = require("./initiateBucketWorm");
const listBucketInventory_1 = require("./listBucketInventory");
const listBuckets_1 = require("./listBuckets");
const putBucket_1 = require("./putBucket");
const putBucketACL_1 = require("./putBucketACL");
const putBucketCORS_1 = require("./putBucketCORS");
const putBucketEncryption_1 = require("./putBucketEncryption");
const putBucketInventory_1 = require("./putBucketInventory");
const putBucketLifecycle_1 = require("./putBucketLifecycle");
const putBucketLogging_1 = require("./putBucketLogging");
...
const getBucketStat_1 = require("./getBucketStat");
exports.default = {
