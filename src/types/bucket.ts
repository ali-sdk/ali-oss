...
type InventoryOptionalFields = 'Size' | 'LastModifiedDate' | 'ETag' | 'StorageClass' | 'IsMultipartUploaded' | 'EncryptionStatus';
...
export type PutBucketInventoryConfig = PartialKeys<Omit<BucketInventory, 'schedule'>, 'prefix' | 'optionalFields'>;
