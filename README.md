...
<script type="text/javascript">
  ...
  client
    ...
    .then(result => {
      ...
      return client.put('my-obj', new File(['hello world'], 'a'));
    })
    .then(result => {
...
| OperationNotSupportedError               | OperationNotSupported               | 400    | The operation is not supported for this resource | 该资源暂不支持 restore 操作            |
