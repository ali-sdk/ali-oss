...
describe('test/object.test.js', () => {
  ...
  describe('mimetype', () => {
    ...
    // TODO wait multipart async await refactor finish then open this case
    it.skip('should set mimetype by file ext', async () => {
    ...
    // TODO wait multipart async await refactor finish then open this case
    it.skip('should set mimetype by object key', async () => {
    ...
    // TODO wait multipart async await refactor finish then open this case
    it.skip('should set user-specified mimetype', async () => {
      const filepath = path.join(tmpdir, 'content-type-by-file.jpg');
      await createFile(filepath);
      const name = `${prefix}ali-sdk/oss/content-type-by-file.png`;
